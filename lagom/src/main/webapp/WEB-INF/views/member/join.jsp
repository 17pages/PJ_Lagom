...
@
keyframes ani_loading {from {-webkit-transform :rotate(0deg);
							...
							<div class="sns_wrap">
								...
								<div class="sns_logo">
									<a href="#" class="kakao"> <img
										src="${path}/resources/img/ic-kakao.svg" width="50"
										height="50">
									</a>
								</div>
							</div>
						...
						<div class="row_group">
							...
							<div class="join_row join_addr">
								...
								<div class="addr_wrap">
									...
									<div class="addr_addr">
										<span class="ps_box"> <input name="addr1" type="text"
											id="sample6_address" name="mail" class="int addr_only"
	...
	$(function() {
		...
		if ('${user}' != '') {
			...
			$('.join_row:eq(1)').css('visibility', 'hidden')
								.css('height', '0px')
								.css('margin-top', '-17px');
			$('.join_row:eq(2)').css('visivility', 'hidden')
								.css('height', '0px')
								.css('margin-top', '-17px');
			//id에 readonly효과를 줘서 입력이 불가능
			//id=#id를 제거해서 우리가 입력한 유효성체크 동작 불가능

			$('.ps_box_input:eq(0)').attr('readonly', 'true').removeAttr('id');
			$('.int_id').css('background-color', '#ffffcc')
						.css('pointer-events', 'none');
			$('#uid').css('background-color', '#ffffcc')
						.css('cursor', 'default');
