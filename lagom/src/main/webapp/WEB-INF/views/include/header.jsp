	...
	<div class="modal_wrap">
		<div class="modal_content">
			...
			<div class="modal_header">
				<a href="#" class="modal_header_link">
					<span class="icon_lagom"><img src="${path}/resources/img/logo_brown.png" width="160px" height="80px"></span>
				</a>	
			</div>
			...
			<div class="modal_login">
				...
				<div class="div_input" id="logom_id">
					<input type="email" placeholder="이메일" class="input_login" id="input_id" required>
						<span class="input_box"></span>
				</div>
				<div class="div_input" id="logam_pw">
					<div class="input_pw">
						<input type="password" placeholder="비밀번호" class="input_login" id="input_pw" required minlength="6" maxlength="18">
						<span class="pw_eye">
				...
				<div class="simple" id="simple">
					<span class="simple">SNS 계정으로 간편 로그인</span>
						<div class="sns_wrap">
							<div class="sns_logo" ><a href="#" class="naver"><img src="${path}/resources/img/naver_round.png" width="48px" height="48px"></a></div>
							<div class="sns_logo"><a href="#" class="facebook"><img src="${path}/resources/img/facebook_logo2.png" width="48" height="48"></a></div>
							<div class="sns_logo"><a href="#" class="facebook"><img src="${path}/resources/img/ic-kakao.svg" width="50" height="50"></a></div>
						</div>
				</div>
		...
		<div class="header_wrap">
			<div class="header_content">
				<div class="header_content_logo">
					<a href="#">
					<img class="header_content_logo_img" src="${path}/resources/img/logo_brown.png">
					<span></span>
					</a>
				</div>
				...
				<div class="header_content_nav">
					<div class="header_content_dropdown_wrap">
						...
						<!-- 네비게이션 -->
							<a href="#" class="magicline"><i class="fas fa-bars"></i> 카테고리</a>
					...
					<div class="header_content_dropdwon_group"><a href="#" class="magicline">스토어</a></div>
					<div class="header_content_dropdwon_group"><a href="#" class="magicline">커뮤니티</a></div>
				</div>

				<div class="header_content_search">
					<form name="frm_search" action="" method="GET">
						<div class="header_content_search_group">
							<input type="text" name="keyword" placeholder="상품검색" class="header_content_search_input">
...
<script type="text/javascript">
	...
	$(document).on('click', '.login_close', function(){
		...
		$('.pw_eye').html('<i class="fas fa-eye-slash"></i>').css('color','#AAA');
	});
	...
	$(document).on('click', '.pw_eye', function(){
		...
		if(code == 'password') {
			...
			$(this).html('<i class="fas fa-eye-slash"></i>').css('color','#AAA');
		}
